    ...
    <div style={{margin:'6%'}}>
     ...
     <Grid container spacing={2}>
       ...
       <Grid item xs={12} sm={12} md={12}>
        <TextField variant='outlined' label='post title' fullWidth value={post.title}
         name='title' onChange={inputHandler} />
       </Grid>

       <Grid item xs={12} sm={12} md={12}>
        <TextField variant='outlined' label='type a post' fullWidth value={post.post}
         rows={10} multiline name='post' onChange={inputHandler}/>
       </Grid>

       <Grid item xs={12} sm={12} md={12}>
        <TextField variant='outlined' label='IMAGE URL' fullWidth value={post.image}
        name='image' onChange={inputHandler}/>
       </Grid>
